    ...
    <div class="card w-3/4 lg:w-full">
        <div class="card-body">
            <div class="flex flex-row justify-between items-center">
                ...
                <a href="{{ route('products.index') }}" class="btn-gray text-sm">Back to Products</a>
            </div>
            ...
            <form action="{{ route('products.store') }}" method="POST" class="mt-5" enctype="multipart/form-data">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="name" id="name" class="input-text mt-2 w-full rounded-lg" required
                ...
                <div class="flex flex-col mt-5">
                    ...
                    <input type="text" name="slug" id="slug" class="input-text mt-2 w-full rounded-lg" required
                        value="{{ old('slug') }}">
                    @error('slug')
                        <span class="text-xs text-red-600">{{ $message }}</span>
                    @enderror
                ...
                <div class="flex flex-col mt-5">
                    ...
                    <input type="file" name="image" id="image" class="input-text mt-2 w-full rounded-lg" required
                ...
                <div class="flex flex-col mt-5">
                    ...
                    <input type="text" name="color" id="color" class="input-text mt-2 w-full rounded-lg" required
                        value="{{ old('color') }}">
                    @error('color')
                        <span class="text-xs text-red-600">{{ $message }}</span>
                    @enderror
